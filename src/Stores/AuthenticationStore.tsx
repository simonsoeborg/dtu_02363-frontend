...
class AuthStore {
    ...
    authTemp : AuthenticationModel = new AuthenticationModel("", false, "", "", "", "");
    ...
    getAuthenticatedUsersAsync = async () => {
        const response = await fetch(API_URL + "/Authentication/AuthenticatedUsers/" + this.getJWT());
        const data = await response.json();
        this.setAuthList(data);
    }

    getAuthUserByEmailAsync = async (email : string) => {
        const response = await fetch(API_URL + "/Authentication/" + email + "/" + this.getJWT());
        const data = await response.json();
    ...
    putTemporaryAuthUser = async () => {
        ...
        instance.put("/Authentication/AuthenticatedUsers/"+this.getJWT()+"/"+this.AuthTemp.email, JSON.stringify(this.AuthTemp));
